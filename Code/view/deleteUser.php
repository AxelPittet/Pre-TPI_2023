...
<div class="hero min-h-screen bg-base-200">
    <div class="hero-content text-center">
        <div class="w-screen">
            <h1 class="text-5xl font-bold">Delete user</h1>
            <div class="divider"></div>
            <div class="card-body">
                <form action="index.php?action=admin&adminFunction=users&usersFunction=delete" method="post">
                    ...
                    <div class="form-control mt-6">
                        <input type="submit" value="Delete the user" class="btn btn-primary"/>
                    </div>
                </form>
            </div>
        </div>
